...
#section_timeline(
  ...
  content: (
    ...
    entry_main(when: [Dec. 2021 – Nov. 2022], where: [AFoDIB], title: [President])[Association of Computer Science Ph.D. Students in Bordeaux.
      I was also *secretary* _(Dec. 2020 – Nov. 2021)_ and *member of the board*
      _(Dec. 2022 – Nov. 2023)_.],
    // entry_main(when: [Sep. 2018 – Mar. 2019], where: [La Cinquième Parallèle], title: [Treasurer])[LGBTIQ+ Student Association at ENS Paris-Saclay.],
  ),
)
